        ...
        return (
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                        <Link to="/content/contactUs">
                            <MenuItem image="/image/menuIcon/email.png" title={dict.contactUs} />
                        </Link>
                    </div>
                    <div className="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                        <Link to="/content/aboutUs">
                            <MenuItem image="/image/menuIcon/about.png" title={dict.aboutUs} />
                        </Link>
                    </div>
                </div>
            </div>
